...
/*Pro komunikaci s modulem přes mobil je potřeba aplikace, např. Serial Bluethooth Terminal od Kai Morich.
V původním kódu byla chyba ve switchi, konkrétně v 3. a 4. case:   case 'r':   namísto   case '\r':    */
